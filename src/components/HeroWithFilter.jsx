...
export default function HeroWithFilter() {
    return (
        <section className="bg-[url('./assets/images/hero.png')] h-[596px] bg-cover w-full md:w-[95%] mx-auto relative ">
            <h1 className="md:text-big-heading text-xl text-white md:w-[30%] w-[90%] mx-auto text-center pt-32">
                MADE FOR THOSE WHO DO
            </h1>
            
            <form className="bg-navy-blue w-[90%] mx-auto py-6 px-4 md:px-10 flex flex-col md:flex-row md:justify-between gap-4 md:gap-8 rounded-md absolute -bottom-20 md:-bottom-8 left-1/2 transform -translate-x-1/2 ">
